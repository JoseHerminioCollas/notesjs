/*	/js/data_tool/tools.js : Jose Collas  5.16.2015  */
// TODO hide d3GraphData in object
var d3GraphData = {
	nodes: [],
	links: [] 
};
function makeD3Data(node){
	...
	d3GraphData.nodes.push({x:xNew, y:yNew, value:node.value, id: "node_"+node.id});
	//d3GraphData.id = node.id;
